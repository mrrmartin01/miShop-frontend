let all_products = [
  ...
  },
  {
    ...
    description: "Fair & Clear is Pakistan's only pure Freckle cream which helpsfade Freckles, Darkspots and pigments. Mercury level is 0%, so there are n se effects.",
    price: 70,
  ...
  },
  {
    id: 34,
    title: "Plastic Table",
    description: "Very good quality plastic table for multi purpose now in reasonableprice",
    price: 50,
